import { isArray, isString, isObject, isFunction, isEmpty, forIn, forOwn, each } from 'lodash'
...
export function applyMask (data, schema) {
  if (isArray(data)) {
    let a = []
